...
#### 📦 [v2socks](https://github.com/Hiddenioum/v2socks)
> A Python library for running Xray configs as local SOCKS5 proxies.

- Easy to integrate with Python applications.
- Supports parsing and running Xray configs on the fly.
